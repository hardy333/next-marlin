export const Icon1 = () => {
  return (
    <svg
      ...
      height="66"
      viewBox="0 0 24 24"
      className="duoicon duoicon-approved"
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M10.586 2.1a2 2 0 0 1 2.7-.116l.128.117L15.314 4H18a2 2 0 0 1 1.994 1.85L20 6v2.686l1.9 1.9a2 2 0 0 1 .116 2.701l-.117.127-1.9 1.9V18a2 2 0 0 1-1.85 1.995L18 20h-2.685l-1.9 1.9a2 2 0 0 1-2.701.116l-.127-.116-1.9-1.9H6a2 2 0 0 1-1.995-1.85L4 18v-2.686l-1.9-1.9a2 2 0 0 1-.116-2.701l.116-.127 1.9-1.9V6a2 2 0 0 1 1.85-1.994L6 4h2.686l1.9-1.9Z"
      ...
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="m15.079 8.983-4.244 4.244-1.768-1.768a1 1 0 1 0-1.414 1.415l2.404 2.404a1.1 1.1 0 0 0 1.556 0l4.88-4.881a1 1 0 0 0-1.414-1.414Z"
  ...
  return (
    <>
      <svg
        ...
        height="66"
        viewBox="0 0 24 24"
        className="duoicon duoicon-credit-card duoicon-primary:text-indigo-500 "
      >
        <path
          fill="currentColor"
...
export const Icon3 = () => {
  return (
    <svg
      ...
      height="66"
      viewBox="0 0 24 24"
      className="duoicon duoicon-world duoicon-primary:text-indigo-500 "
    >
      <path
        fill="currentColor"
...
export const Icon4 = () => {
  return (
    <svg
      ...
      height="66"
      viewBox="0 0 24 24"
      className="duoicon duoicon-discount duoicon-primary:text-indigo-500 "
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
...
export const Icon5 = () => {
  return (
    <svg
      ...
      height="66"
      viewBox="0 0 24 24"
      className="duoicon duoicon-bookmark duoicon-primary:text-indigo-500 "
    >
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M17 2a3 3 0 0 1 3 3v16a1 1 0 0 1-1.625.78l-1.875-1.5-1.875 1.5a1 1 0 0 1-1.332-.073L12 20.414l-1.293 1.293a1 1 0 0 1-1.332.074L7.5 20.28l-1.875 1.5A1 1 0 0 1 4 21V5a3 3 0 0 1 3-3h10Z"
        className="duoicon-secondary-layer"
        opacity=".3"
      ></path>
      <path
        fill="currentColor"
        fillRule="evenodd"
        d="M15 8H9a1 1 0 0 0-.117 1.993L9 10h6a1 1 0 0 0 .117-1.993L15 8Zm-3 4H9a1 1 0 1 0 0 2h3a1 1 0 1 0 0-2Z"
        className="duoicon-primary-layer"
      ></path>
    </svg>
  );
...
export const Icon6 = () => {
  return (
    <svg
      ...
      height="66"
      viewBox="0 0 24 24"
      className="duoicon duoicon-bell-badge duoicon-primary:text-indigo-500 "
    >
      <path
        fill="currentColor"
        d="M18.5 9c.338 0 .664-.048.973-.137.018.211.027.425.027.64v4l1.418 3.16A.95.95 0 0 1 20.052 18h-16.1a.95.95 0 0 1-.867-1.338l1.415-3.16V9.49l.005-.25c.201-5.749 6.533-9.14 11.43-6.123-1.834 1.973-.845 5.193 1.781 5.795A3.5 3.5 0 0 0 18.5 9Z"
        className="duoicon-secondary-layer"
        opacity=".3"
      ></path>
      <path
        fill="currentColor"
        d="M18.5 8c1.925 0 3.127-2.083 2.165-3.75A2.5 2.5 0 0 0 18.5 3c-1.925 0-3.127 2.083-2.165 3.75A2.5 2.5 0 0 0 18.5 8Zm-3.542 11.003c-.385 2.277-3.09 3.283-4.87 1.811a3 3 0 0 1-1.046-1.811h5.916Z"
        className="duoicon-primary-layer"
      ></path>
    </svg>
  );
