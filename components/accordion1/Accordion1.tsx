...
const AccordionTrigger = React.forwardRef<HTMLButtonElement, TriggerProps>(({ children, className, ...props }: TriggerProps, forwardedRef ) => (
...
const AccordionContent = React.forwardRef<HTMLDivElement, ContentType>(({ children, className, ...props }, forwardedRef) => (
  <Accordion.Content
